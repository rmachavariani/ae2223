    ...
    for grid in grids:
        ...
        if planes.count("xz") == 1:
            ...
            if typ == "nor" or typ == "gauss" or typ == "poly":
                ...
                axes.set_xticks(np.arange(round((min(yxz_values) / 0.15) * 2) / 2, (max(yxz_values) / 0.15), step=0.5))
        ...
        if planes.count("xy") == 1:
            ...
            if typ == "nor" or typ == "gauss" or typ == "poly":
                ...
                axes.set_xticks(np.arange(round((min(yxy_values) / 0.15) * 2) / 2, (max(yxy_values) / 0.15), step=0.5))
                axes.set_yticks(np.arange(round((min(zxy_values) / 0.15) * 2) / 2, (max(zxy_values) / 0.15), step=0.5))
