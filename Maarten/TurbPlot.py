...
def plotting(plane,location, locstr, number):
    ...
    for grid in grids:
        ...
        if plane == "yz":
            ...
            plt.contourf(b_lst, c_lst, e_lst, 100, levels=levels, cmap=cm.jet)
        elif plane == "xz":
            ...
            plt.contourf(a_lst, c_lst, e_lst, 100, levels=levels, cmap=cm.jet)
        elif plane == "xy":
            ...
            plt.contourf(a_lst, b_lst, e_lst, 100, levels=levels, cmap=cm.jet)
