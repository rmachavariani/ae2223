...
def upload():
    ...
    datalocation = "/Users/rosal/OneDrive/TU Delft/Year 2/Test, Analysis and Simulation/carMirrorData.dat"
...
class GridBin:
    ...
    def biggrid(self):
        # make list with all big bins were the particle information can be added to
        bigbinxyz = [[[[] for k in range(self.windowz)] for l in range(self.windowy)] for i in
                  range(self.windowx)]  # [x:[y:[z:[particle data:()]]]]
